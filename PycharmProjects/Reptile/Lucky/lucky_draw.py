...
class LuckyDraw:
    def __init__(self,data):
        ...
        self.image = Image.open("e:/pscrapy/pycharmprojects/reptile/lucky/static/background.png")
        self.im = ImageTk.PhotoImage(self.image)
        self.canvas.create_image(680, 350, image=self.im)  # 使用create_image将图片添加到Canvas组件中
        self.canvas.pack()

        reset_img = Image.open("e:/pscrapy/pycharmprojects/reptile/lucky/static/reset.png")
        ...
        nose_img = Image.open("e:/pscrapy/pycharmprojects/reptile/lucky/static/nose.png")
        ...
        img_03 = Image.open("e:/pscrapy/pycharmprojects/reptile/lucky/static/003.png")
        ...
        img_02 = Image.open("e:/pscrapy/pycharmprojects/reptile/lucky/static/002.png")
        ...
        img_01 = Image.open("e:/pscrapy/pycharmprojects/reptile/lucky/static/001.png")
...
if __name__ == "__main__":
    data = pd.read_excel("E:/Pscrapy/PycharmProjects/Reptile/Lucky/demo.xlsx")
