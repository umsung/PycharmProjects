...
from PycharmProjects.Reptile.CookiesPool.cookiespool.db import *
from PycharmProjects.Reptile.CookiesPool.cookiespool.generator import WeiboCookiesGenerator
