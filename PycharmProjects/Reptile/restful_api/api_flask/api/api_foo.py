...
class FooListApi(Resource):
    ...
    responses:
      200:
        ...
        print(foos,type(foos))
        return foos
        # return success('成功',foos)
...
class FooApi(Resource):
    ...
    def post(self):
        ...
        """
        # 参数
        # params = request.get_json()   # 默认请求的格式是application/x-www-form-urlencoded  使用request.get_json 要改成contentType application/json
        params  = request.form
