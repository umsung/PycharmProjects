...
class Element():
    ...
    # 用例数据路径
    test_login_data = PATH("../TestData/Login/test_login_data.yaml")
    # test_login_usernameFail_data = PATH("../TestData/Login/test_login_usernameFail_data.yaml")
    # test_login_pwdFail_data = PATH("../TestData/Login/test_login_pwdFail_data.yaml")
